...
public class SettingsInjector extends Feature {
    ...
    public SettingsInjector(@NonNull ClassLoader classLoader, @NonNull de.robv.android.xposed.XSharedPreferences preferences) {
    ...
    public void doHook() throws Throwable {
        ...
        try {
            ...
            settingsActivityClass = directClass != null ? directClass : null;
        } catch (Throwable t) {
        ...
        XC_MethodHook menuHook = new XC_MethodHook() {
            ...
            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                // Toolbar menu injection removed in favor of Native View Tile
            }
        };
        ...
        XposedBridge.hookAllMethods(settingsActivityClass, "onResume", new XC_MethodHook() {
            ...
            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                ...
                boolean isEnabled = prefs.getBoolean("open_wae", true);
    ...
    private View createDynamicSettingRow(Activity activity, View anchorView) {
        try {
            ...
            titleText.setText("WaEnhancer Settings");
            ...
            summaryText.setText("Enhance your WhatsApp experience");
            ...
            rowLayout.setOnClickListener(v -> {
                try {
                    ...
                    intent.setClassName("com.wmods.wppenhacer", "com.wmods.wppenhacer.xposed.features.others.EmbeddedSettingsActivity");
                    intent.addFlags(android.content.Intent.FLAG_ACTIVITY_NEW_TASK);
                    activity.startActivity(intent);
                } catch (Exception e) {
                    android.util.Log.e("WaEnhancer", "Failed to start settings", e);
                    try {
                        android.content.Intent intent = activity.getPackageManager().getLaunchIntentForPackage("com.wmods.wppenhacer");
                        if (intent != null) {
                            intent.addFlags(android.content.Intent.FLAG_ACTIVITY_NEW_TASK);
                            activity.startActivity(intent);
                        }
    ...
    private ImageView createSettingsButton(Activity activity) {
        ...
        button.setOnClickListener(v -> activity.startActivity(new android.content.Intent().setClassName("com.wmods.wppenhacer", "com.wmods.wppenhacer.xposed.features.others.EmbeddedSettingsActivity")));
        return button;
    }
    ...
    private void injectToolbarMenu(Menu menu, Activity activity) {
        try {
            if (menu != null && menu.findItem(MENU_ID_WAE_SETTINGS) == null) {
                ...
                try {
                    String moduleTitle = "WaEnhancer Settings";
