...
import com.wmods.wppenhacer.xposed.bridge.client.ProviderSharedPreferences;
import com.wmods.wppenhacer.xposed.utils.ThemeUtils;
import com.wmods.wppenhacer.xposed.utils.Utils;
import com.wmods.wppenhacer.xposed.utils.XPrefManager;
...
public abstract class EmbeddedBasePreferenceFragment extends PreferenceFragmentCompat
    ...
    public android.content.Context getContext() {
        ...
        return new android.view.ContextThemeWrapper(context, themeRes) {
            ...
            public android.content.res.Resources getResources() {
                if (com.wmods.wppenhacer.xposed.utils.XResManager.moduleResources != null) {
                    return com.wmods.wppenhacer.xposed.utils.XResManager.moduleResources;
                }
    ...
    public boolean onPreferenceTreeClick(@NonNull Preference preference) {
        if ("call_recording_settings".equals(preference.getKey())) {
            try {
                ...
                intent.setClassName(BuildConfig.APPLICATION_ID, "com.wmods.wppenhacer.activities.CallRecordingSettingsActivity");
        ...
        if ("call_recording_manage".equals(preference.getKey())) {
            try {
                Intent intent = new Intent();
                intent.setClassName(BuildConfig.APPLICATION_ID, "com.wmods.wppenhacer.activities.RecordingsActivity");
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                requireContext().startActivity(intent);
            } catch (Exception e) {
    ...
    private void applyDynamicStates(@Nullable String key) {
        ...
        if (filterGroupsPreference != null) {
            filterGroupsPreference.setSummary("Not supported on this UI version");
        }

        Preference separateGroupsPreference = findPreference("separategroups");
        if (separateGroupsPreference != null) {
            if (com.wmods.wppenhacer.BuildConfig.DEBUG) {
    ...
    protected boolean checkStoragePermission(Object newValue) {
        if (newValue instanceof Boolean && (Boolean) newValue) {
            ...
            if (denied) {
                com.wmods.wppenhacer.App.showRequestStoragePermission(requireActivity());
                return false;
            }
        }
        return true;
