...
import com.wmods.wppenhacer.xposed.utils.XResManager;
...
public class EmbeddedSettingsDialogFragment extends DialogFragment {
    ...
    private int resolveTheme() {
        ...
        if (ctx == null) return com.wmods.wppenhacer.R.style.Theme;
        return ThemeUtils.isNightMode(ctx)
                ? com.wmods.wppenhacer.R.style.Theme
                : com.wmods.wppenhacer.R.style.Theme_Light;
    }
    ...
    public static void show(@NonNull Activity activity) {
        ...
        try {
            ...
            intent.setComponent(new android.content.ComponentName(
                    com.wmods.wppenhacer.BuildConfig.APPLICATION_ID,
